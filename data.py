...
def generate_fake_data(num_rows=2000):
    ...
    common_names = ["Ahmed", "Fatima", "Ali", "Khadija", "Youssef", "Samira", "Omar", "Amina", "Hassan", "Zineb", "Mehdi", "Soukaina", "Ismail", "Imane", "brahim", "Nadia", "Jamal", "Salma"] # Added a list of common names

    for i in range(num_rows):
        nom = random.choice(common_names) # Randomly select a name from the list
...
if __name__ == "__main__":
    ...
    print("Le fichier CSV 'data.csv' a été généré avec 2000 lignes et des noms plus réalistes.")